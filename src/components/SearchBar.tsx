      ...
      <div className="relative">
        <div ref={ref as any}>
          ...
          {inputHasFocus && searchFilter.length > 0 && (
            <div className="absolute top-10 z-[100] flex h-[50vh] w-full flex-col overflow-y-scroll rounded-sm bg-zinc-900 shadow-sm shadow-zinc-900 scrollbar scrollbar-track-zinc-800 scrollbar-thumb-zinc-900">
